async function testSend() {
  ...
  // TENTANDO O ENDPOINT /whatsapp/notifications
  ...
  console.log(`Tentando envio via /whatsapp/notifications ...`);
  const response = await fetch(`https://api.sendpulse.com/whatsapp/notifications`, {
    method: "POST",
    headers: {
