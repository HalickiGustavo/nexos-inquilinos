        ...
        <div className="relative flex flex-col items-center gap-8 flex-1 justify-center">
          ...
          <div className="text-center max-w-md">
            ...
            <p className="mt-5 text-white/70 text-[15px] leading-relaxed">
              Interface mais bonita e fácil: a tela atual cumpre a função, mas tem aparência datada. Uma versão mais moderna e intuitiva torna o uso diário agradável e ajuda a conquistar e reter clientes.
            </p>
          </div>
        </div>
