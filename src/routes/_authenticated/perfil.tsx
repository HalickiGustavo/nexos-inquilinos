  ...
  return (
    <PageShell narrow>
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Seus dados, chave PIX de recebimento e senha de acesso.</p>
      </div>
